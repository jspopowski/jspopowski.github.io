    ...
    <div class="posters-grid">
      ...
      <div class="poster-card animate-on-scroll" data-poster="active-caging">
        <div class="poster-card__header">
          <div class="poster-card__info">
            <p class="poster-card__venue">NWO Physics</p>
            <h3 class="poster-card__title">Minimal Model of Cage Breaking in Active Matter</h3>
            <p class="poster-card__year">2026</p>
          </div>
          <div class="poster-card__actions">
            <a href="{{ '/docs/assets/posters/Active Caging - NWO Physics 2026.pdf' | relative_url }}"
               class="btn btn--small btn--secondary"
               download
               onclick="event.stopPropagation();">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="poster-card__embed">
          <object data="{{ '/docs/assets/posters/Active Caging - NWO Physics 2026.pdf' | relative_url }}"
                  type="application/pdf"
                  width="100%"
                  height="800px">
